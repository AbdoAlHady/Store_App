...
class _$SuccessStateImpl implements SuccessState {
  const _$SuccessStateImpl({required final List<GetAllProductsModel> products})
      : _products = products;
...
abstract class SuccessState implements SearchState {
  const factory SuccessState(
      {required final List<GetAllProductsModel> products}) = _$SuccessStateImpl;
...
class __$$FailureStateImplCopyWithImpl<$Res>
    extends _$SearchStateCopyWithImpl<$Res, _$FailureStateImpl>
...
abstract class FailureState implements SearchState {

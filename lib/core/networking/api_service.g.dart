...
class _ApiService implements ApiService {
  ...
  Future<ProductNumberResponse> numberOfProdcuts(
    ...
    _data.addAll(query);
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ProductNumberResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ProductNumberResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<CategoriesNumberResonse> numberOfCategories(
    ...
    _data.addAll(query);
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<CategoriesNumberResonse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = CategoriesNumberResonse.fromJson(_result.data!);
    return value;
  }
  ...
  @override
  Future<BannersResponse> getAllBanners(Map<String, dynamic> query) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<GetAllProductsResponse> getCategoryProducts(
      Map<String, dynamic> query) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<GetAllProductsResponse> viewAllProducts(
      Map<String, dynamic> query) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};

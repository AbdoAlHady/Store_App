...
class CustomConatinerGradientCustomer extends StatelessWidget {
  const CustomConatinerGradientCustomer({super.key, required this.width, required this.height, required this.child});
